...
export const QUICK_LABELS = ["胸", "背中", "四頭", "ハムストリングス", "尻", "肩", "二頭", "三頭", "腹筋"];
...
export const SUGGESTIONS = {
    ...
    四頭: ["スクワット", "レッグプレス", "レッグエクステンション", "ハックスクワット", "スミススクワット"],
    ハムストリングス: ["ルーマニアンデッドリフト", "デッドリフト", "シーテッドレッグカール", "ライイングハム", "ブルガリアンスクワット"],
    尻: ["ヒップスラスト", "ブルガリアンスクワット", "ケーブルキックバック", "アブダクション", "グルートブリッジ"],
    肩: ["ショルダープレス", "サイドレイズ", "ケーブルサイドレイズ", "マシンショルダープレス", "スミスショルダープレス", "リアデルトフライ", "アップライトロウ", "ミリタリープレス"],
