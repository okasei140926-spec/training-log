export const S = {
  root: {
    ...
    maxWidth: 430,
    margin: "0 auto",
    paddingBottom: "calc(82px + var(--safe-bottom))",
  },
  page: {
    padding: "18px",
    display: "flex",
  ...
  bottomNav: {
    ...
    boxShadow: "0 -1px 4px rgba(15,94,99,0.03)",
    display: "flex",
    minHeight: "calc(62px + var(--safe-bottom))",
