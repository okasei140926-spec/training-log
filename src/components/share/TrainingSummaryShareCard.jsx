  ...
  return (
    <div
      ...
      style={{
        ...
        display: "flex",
        flexDirection: "column",
        padding: isStory ? "24px 24px 26px" : "22px 22px 24px",
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginBottom: 18 }}>
        <div>
          ...
          <div style={{ fontSize: isStory ? 28 : 30, fontWeight: 900, color: "#fff", marginBottom: 6, lineHeight: isStory ? 1.05 : 1.08 }}>
            {summary.shareLabel}
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: isStory ? 10 : 12, marginBottom: isStory ? 16 : 18 }}>
      ...
      {isStory && (
        ...
        >
          ...
          {trendItems.length > 0 ? (
            <div style={{ display: "flex", alignItems: "flex-end", gap: trendItems.length > 10 ? 4 : 6, height: 136 }}>
              {trendItems.map((item) => (
                <div
                  key={item.date}
                  style={{
                ...
                >
                  ...
                  <div style={{ fontSize: 9, color: "rgba(255,255,255,0.72)", minHeight: 11 }}>
                    {item.displayLabel}
                  </div>
                </div>
              ))}
