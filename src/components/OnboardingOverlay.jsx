...
const STEPS = [
  ...
  {
    title: "① 部位を選ぼう",
    body: "記録タブでトレーニングしたい部位をタップして選択。複数選択もできます。",
    hint: "例：胸・背中・肩 など",
  },
  {
    title: "② メニューを確認",
    body: "種目は右下の＋ボタンから追加できます。よく使う種目を並べ替えて、自分の順番で記録できます。",
    hint: "部位ごとの候補から追加しても、フリーで始めても OK",
  },
  {
    title: "③ トレーニングを記録",
    body: "重量と回数を入力するとセット完了。記録は自動で保存され、履歴やPRは記録タブ・PRタブで確認できます。",
    hint: "自重トレには「自重」ボタン、ポンド派には種目ごとに lbs 切替も可能。Friendsや通知はあとから設定できます。",
  },
];
